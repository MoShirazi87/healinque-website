...
const faqs = [
  {
    ...
    answer: "There is no hard age requirement. Many patients in their late 20s and 30s start with preventative neuromodulators or skin-quality treatments, while others begin addressing volume loss or skin laxity later. During your consultation, Dr. Shirazi evaluates your skin, anatomy, and goals to recommend what makes sense for where you are right now.",
  },
  {
    question: "How long do results typically last?",
    answer: "It depends on the treatment. Neuromodulators (Botox, Dysport) typically last 3–4 months. Hyaluronic acid fillers last 6–18 months depending on the product and placement area. Biostimulators like Sculptra can last two years or more. Laser and microneedling results build over a series and can last a year or longer with proper skincare. We'll map out a realistic timeline during your consultation.",
  },
  {
    question: "What should I expect during my first consultation?",
    answer: "Your consultation is a 45–60 minute appointment with Dr. Shirazi. She will review your medical history, assess your concerns, examine your skin and facial anatomy, and walk you through her recommendations. You'll leave with a written treatment plan, realistic expectations, and transparent pricing. The $100 consultation fee is credited toward any treatment you choose.",
  },
  {
    question: "Are treatments painful?",
    answer: "Most injectable treatments feel like a brief pinch. We use topical numbing for procedures like microneedling, laser resurfacing, and PRP. Dr. Shirazi prioritizes comfort — if you're nervous, just tell us. We will walk you through every step before anything happens.",
  },
  {
    question: "Do you offer financing options?",
    answer: "Yes. We partner with CareCredit and Cherry for flexible payment plans, including 0% APR options for qualified applicants. We also accept HSA/FSA cards for qualifying services. Ask our team for details when you book.",
  },
  {
    question: "What is your cancellation policy?",
    answer: "We ask for 48 hours' notice for cancellations or rescheduling. Late cancellations or no-shows may incur a $50 fee. If something comes up last minute, call us — we understand life happens.",
  },
];
...
export function FAQSection() {
  ...
  return (
    <section className="relative py-24 md:py-40 bg-[#0d1b2e] overflow-hidden orb-bg has-particles" data-wipe>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6 leading-tight">
              Before You <span className="text-gold italic heading-shimmer">Book</span>
            </h2>

            {/* Supporting text */}
            <p className="text-lg text-white/65 leading-relaxed mb-10">
              Everything you need to know about treatments, pricing, and what to expect during your time with us.
            </p>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  data-interactive=""
                  data-ripple=""
                  className="w-full text-left p-6 md:p-8 rounded-xl bg-surface-card border border-white/5 hover:border-gold/20 transition-all duration-300 hover:bg-surface-card/95 card-interactive"
                >
