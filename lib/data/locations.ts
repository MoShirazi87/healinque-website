...
export const locationPages: LocationPage[] = [
  {
    ...
    localInfo: "Healinque is located at 15644 Pomerado Road, Suite 103, Poway, CA 92064. We serve patients across San Diego County, including Rancho Bernardo, Scripps Ranch, Escondido, San Marcos, and Del Mar. Easy parking, convenient hours, and a focus on natural, medically sound results.",
  ...
  },
  {
    ...
    description: "Healinque serves Rancho Bernardo residents from our Poway location, just 10 minutes away. Physician-led Botox, fillers, laser treatments, and wellness services.",
    heroTitle: "Aesthetic Medicine for Rancho Bernardo Residents",
    heroSubtitle: "Located in Nearby Poway",
    localInfo: "Rancho Bernardo residents enjoy convenient access to Healinque, located just 10 minutes away in Poway. Our physician-led practice offers personalized aesthetic medicine and wellness treatments in a refined, discreet setting. From Rancho Bernardo, take Pomerado Road south to our clinic at Suite 103.",
  ...
  },
  {
    ...
    localInfo: "Scripps Ranch residents can reach Healinque in about 12 minutes via Scripps Poway Parkway. Our boutique clinic in Poway offers a refined alternative to commercial chain med spas, with personalized care from Dr. Shirazi and a focus on natural, medically sound results.",
  ...
  },
  {
    ...
    localInfo: "Escondido residents drive 15-20 minutes to reach Healinque's physician-led practice in Poway. Dr. Shirazi's approach to natural, medically sound aesthetic medicine and our focus on personalized care make the short commute worthwhile for patients seeking authentic results.",
  ...
  },
  {
    ...
    localInfo: "San Marcos residents seeking refined aesthetic medicine can reach Healinque in Poway in approximately 20 minutes. Our focus on natural results and medically sound treatments makes us a trusted choice for patients throughout North County San Diego.",
  ...
  },
  {
    ...
    localInfo: "Del Mar residents appreciate Healinque's physician-led approach to aesthetic medicine. Located in Poway, just 20-25 minutes away, our practice offers personalized care and a focus on natural, sophisticated results that align with the refined aesthetic of coastal San Diego.",
