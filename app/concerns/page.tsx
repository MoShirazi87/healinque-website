  ...
  return (
    <main className="bg-[#0a1628]">
      <Hero
        ...
        description="Every patient is unique. Tell me what's bothering you, and I'll help you find the treatments that can make a difference."
        ...
        <div className="container-healinque">
          ...
          >
            ...
            <p className="text-navy-deep/70 text-lg leading-relaxed">
              ...
              expected results, and at-home care. If you&apos;re not sure what you need, I&apos;m here
              to help you decide.
            </p>
          </div>
        </div>
      ...
      <ConsultationForm
        variant="split"
        title="Tell Me About Your Concerns"
