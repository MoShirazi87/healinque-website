...
const categories = [
  { id: 'aesthetics' as TreatmentCategory, label: 'Aesthetics', display: 'AESTHETIC TREATMENTS' },
  { id: 'skin-rejuvenation' as TreatmentCategory, label: 'Skin Rejuvenation', display: 'SKIN REJUVENATION' },
  { id: 'hair-restoration' as TreatmentCategory, label: 'Hair Restoration', display: 'HAIR RESTORATION' },
] as const;
  ...
  return (
    <main className="bg-navy-deep text-white">
      ...
      <PageHero
        ...
        description="Explore my full collection of physician-performed aesthetic enhancements, advanced skin science, regenerative medicine, and longevity protocols. Every treatment is personally delivered or directly supervised by me."
      ...
      {/* Main Content */}
      <section className="bg-navy-deep py-20 md:py-32 relative overflow-hidden">
      ...
      {/* Premium CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-gold/10 via-navy-deep to-navy-deep border-t border-gold/20 py-24 md:py-32">
        {/* Accent Elements */}
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-xl max-w-2xl mx-auto leading-relaxed font-light">
              Schedule your consultation with me. I&apos;ll discuss which treatments align with your goals and build a plan that works for you.
            </p>
          </div>
  ...
  return (
    ...
    >
      <Link href={`/treatments/${treatment.slug}`} className="group h-full block">
        <motion.div
          className="h-full flex flex-col bg-gradient-to-br from-white/5 to-white/2 border border-white/5 rounded-2xl overflow-hidden backdrop-blur-sm hover:border-gold/30 transition-colors duration-300"
          onHoverStart={() => setIsHovered(true)}
          onHoverEnd={() => setIsHovered(false)}
        >
          {/* Premium Image Container — flip-overlay pattern (Option B) */}
          <div
            className={`flip-overlay-host relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 ${
          ...
          >
            ...
            <div className="flip-overlay-chrome absolute inset-0 pointer-events-none">
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-navy-deep via-transparent to-transparent opacity-40 transition-opacity duration-500" />
              ...
              {/* Description Reveal on Hover (part of chrome) */}
              <AnimatePresence>
                {isHovered && (
                  <motion.div
            ...
            {/* Clean title — slides in from bottom on hover */}
            <div className="flip-overlay-clean-title">
              {treatment.name}
            </div>
          </div>
          ...
          <div className="flex-1 p-8 flex flex-col bg-gradient-to-b from-white/3 to-transparent">
            ...
            {/* Session 22: Stronger outcome verb. */}
            <motion.div
